export const translations = {
  en: {
    ...
    manualSearch: "Manual location",
    language: "Language",
    clockMode: "Clock Mode",
    digital: "Digital",
    analog: "Analog",
    calculationMethod: "Calculation Method",
    calculationMethodHint: "Times vary by the chosen authority",
    ...
    prayerTimeAdjustmentsHint: "Align times with your local mosque",
    hijriOffset: "Hijri Date Adjustment",
    hijriOffsetHint: "Match the local moon sighting",
    hijriOffsetOff: "Off",
    daysUnit: "days",
    save: "Save",
    reset: "Reset All",
  ...
  ar: {
    ...
    locationName: "الموقع",
    manualSearch: "موقع محدَّد يدوياً",
    language: "اللغة",
    clockMode: "وضع الساعة",
    digital: "رقمية",
    analog: "تناظرية",
    calculationMethod: "طريقة الحساب",
    calculationMethodHint: "تختلف المواقيت باختلاف الطريقة",
    ...
    prayerTimeAdjustmentsHint: "لمطابقة المواقيت مع مسجدك",
    hijriOffset: "تعديل التاريخ الهجري",
    hijriOffsetHint: "طابق رؤية الهلال المحلية",
    hijriOffsetOff: "معطل",
    daysUnit: "أيام",
    save: "حفظ",
