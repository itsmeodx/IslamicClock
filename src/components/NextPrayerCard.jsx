...
function NextPrayerCard() {
  ...
  return (
    <div className="heritage-card flex-1 flex flex-col items-center justify-center text-center border-heritage-amber/40 overflow-hidden min-h-[140px] sm:min-h-[250px] p-1.5 sm:p-6 transition-all duration-300">
